 ...
 * i2c.c
 *
 * Description: The I2C bus supports operation of the function generator and multimeter.
 * The I2C is currently configured for interrupt operation, but in the future operation
 * would be relegated to DMA.
 *
 */
...
/*
 * Initialize I2C to use interrupts and operate at 400 KHz. Port pins are configured
 * here as suggested by the reference manual.
 *
 */
void Init_I2C(void){
