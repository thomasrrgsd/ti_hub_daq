 ...
 * logizer.c
 *
 * Description: The logic analyzer just checks the specified GPIO pins and
 * puts all of them into one 8 bit variable that is then sent off over UART2
 * to the wifi module. Data is only sent over serial if the 8 bit variable
 * changes value.
 *
 */
