 ...
 * multimeter.h
 *
 * Description: Header containing definitions needed for operation of digital
 * multimeter (DMM).
 *
 */
...
extern int  dmm_values[5];      // Used by i2c_ti82.c
extern char dmm_value_select;   // Used by i2c_ti82.c
